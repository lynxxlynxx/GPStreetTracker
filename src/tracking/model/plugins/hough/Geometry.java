...
//    }
    ...
    /**
     * Find the intersections between a polygon and a straight line. NOTE: This method is only
     * guaranteed to work if the polygon is first preprocessed so that "unneccesary" vertices are
     * removed (i.e vertices on the straight line between its neighbours).
     * 
     * @param x
     *            X coordinates of polygon.
     * @param y
...
//        double xi, yi;
     ...
     * specified polyline, as follows: 0,4--, \ --, \ --, \ --, \ --,
     * -------------------------3-----------1 / --' / --' / --' / --' 2--'
     * 
     * @param x
